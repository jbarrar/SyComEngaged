<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-newUser.aspx.cs" Inherits="SyComEngaged.Content.ajax.admin_newUser" %>
...
<body>
    ...
    <div class="adminNewdiv">
        <div class="divnewLeft">
        ...
        <div class="divnewRight">
            ...
            <dx:ASPxLabel runat="server" ID="lblBirthday" AssociatedControlID="calBirthDate" Text="Birth Date: "></dx:ASPxLabel><dx:ASPxCalendar ID="calBirthDate" runat="server"></dx:ASPxCalendar><br />
